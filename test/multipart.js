...
//   server.use(function * () {
//     test.deepEqual(this.request.body.files, this.request.files)
//     test.strictEqual(this.request.body.files.foo.name, 'LICENSE')
//     test.strictEqual(this.request.body.files.bar.name, 'utils.js')
//   })
//   request(server.callback())
//     .post('/')
//     .type('multipart/form-data')
...
test('should get multipart files and fields', function (done) {
  ...
  server.use(function * () {
    test.deepEqual(this.request.body.files, this.request.files)
    test.strictEqual(this.request.body.files.pkg.name, 'package.json')
    test.strictEqual(this.request.body.a, 'b')
...
//   var server = koa().use(betterBody())
//   server.use(function * () {
//     test.strictEqual(this.request.body.files.pkg[0].name, 'package.json')
//     test.strictEqual(this.request.body.files.pkg[1].name, 'utils.js')
//   })
//   request(server.callback())
//     .post('/')
//     .type('multipart/form-data')
...
//   var server = koa().use(betterBody())
//   server.use(function * () {
//     test.deepEqual(this.request.body.foo, ['bar', 'baz'])
//     test.strictEqual(this.request.body.baz, 'qux')
//   })
//   request(server.callback())
//     .post('/')
//     .type('multipart/form-data')
